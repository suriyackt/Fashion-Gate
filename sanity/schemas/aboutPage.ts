...
export const aboutPage = defineType({
  ...
  initialValue: {
    title: { en: "About Fashion Gate", ar: "عن فاشن جيت" },
    ...
    p1: {
      ...
      ar: "فاشن جيت هي وجهة التجزئة الفاخرة الرائدة في سوريا، حيث تجمع بين عالم الموضة العالمية، الجمال، وأسلوب الحياة في بيئة واحدة متميزة."
    },
    p2: {
      ...
      ar: "تقع فاشن جيت في بوليفارد دمشق، وهو أحد الوجهات التجارية والسياحية الراقية الناشئة في سوريا، وتقدم مفهوماً جديداً للتسوق الفاخر القائم على الأناقة والاكتشاف والتجارب الاستثنائية."
    },
    p3: {
      ...
      ar: "مستوحاة من أشهر وجهات الفخامة في العالم، تقدم فاشن جيت تشكيلة منسقة بعناية من أزياء وجمال وأسلوب حياة، لتجمع العلامات التجارية الاستثنائية والتجارب التي لا تُنسى تحت سقف واحد."
    },
    p4: {
      ...
      ar: "من الأزياء والإكسسوارات الخالدة إلى منتجات الجمال وأسلوب الحياة والتجارب الحصرية داخل المتجر، تحتفل فاشن جيت بالفردية والحرفية والفخامة الحديثة. تم تصميم كل التفاصيل بعناية لخلق جو يمكن العملاء من الاكتشاف والاستمتاع بتجربة تسوق راقية."
    },
    p5: {
      ...
      ar: "أكثر من مجرد وجهة تسوق، فاشن جيت هي مكان تلتقي فيه الموضة والثقافة والضيافة. مع تصميماتها الداخلية الأنيقة، ومساحاتها المنسقة، ومقهى التوقيع الخاص بها، فإنها توفر للزوار بيئة ترحيبية للاسترخاء واكتشاف المجموعات الجديدة والاستمتاع بلحظات تتجاوز البيع بالتجزئة التقليدي."
    },
    p6: {
      ...
      ar: "كجزء من رؤية بوليفارد دمشق لخلق وجهة حيوية للتجارة والسياحة وأسلوب الحياة، تمثل فاشن جيت فصلاً جديداً لتجزئة الفخامة في دمشق. وتهدف إلى أن تصبح وجهة يمكن لعشاق الموضة والعائلات والزوار تجربة الجودة والأناقة والخدمة الاستثنائية."
    },
    p7: {
      ...
      ar: "في فاشن جيت، لا تقتصر الفخامة على العلامات التجارية التي نقدمها فحسب. بل تتعلق بالتجربة التي نخلقها، والأجواء التي نوفرها، والذكريات التي يأخذها عملاؤنا معهم."
    },
    videoTitle: { en: "THE ATELIER EXPERIENCE", ar: "صالون فاشن جيت بوليفارد دمشق" },
    ...
    visionText: {
      ...
      ar: "تتمثل رؤيتنا في تأسيس فاشن جيت كوجهة رائدة لأسلوب الحياة الفاخر في سوريا من خلال الجمع بين الموضة العالمية، والخدمة الاستثنائية، وتجربة العملاء الفريدة. ونهدف إلى خلق مكان تلتقي فيه الموضة والثقافة وأسلوب الحياة."
    },
    ...
    commitmentText: {
      ...
      ar: "في فاشن جيت، نحن ملتزمون بتقديم التميز في كل تفصيل. من مجموعاتنا المختارة بعناية إلى مساحاتنا المصممة بدقة والخدمة الشخصية، نسعى جاهدين لخلق تجربة مبنية على الجودة والأناقة والثقة."
    }
  },
  preview: {
    select: {
